...
<body class="bg-gray-50">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-gray-600">Update tag details</p>
        </div>
            ...
            <form action="{{ route('admin.tags.update', $tag) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-4 p-4 bg-gray-50 rounded-lg">
                        ...
                        <span id="tag-preview" class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium text-white" style="background-color: {{ $tag->color }}">
