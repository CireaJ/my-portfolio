...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>Edit Tech Stack - Admin</title>
      ...
      <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8">
          <h1 class="text-4xl font-bold mb-2">
            <span class="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Edit Tech Stack</span>
          </h1>
          <p class="text-gray-400">Update {{ $techStack->name }}</p>
        ...
        <div class="bg-gray-900 rounded-xl border border-gray-800 p-8">
          <form action="{{ route('admin.tech-stack.update', $techStack) }}" method="POST">
            ...
            <div class="mb-6">
              ...
              <!-- Icon Preview -->
              <div id="icon-preview" class="mb-4">
                <div class="flex items-center gap-4 p-4 bg-gray-800 rounded-lg border border-gray-700">
                  <img id="preview-image" src="{{ $techStack->icon_url }}" alt="Icon preview" class="w-16 h-16 object-contain" onerror="this.src='https://via.placeholder.com/64?text=No+Icon'">
              ...
              <input
                ...
                id="icon_url"
                name="icon_url"
                value="{{ old('icon_url', $techStack->icon_url) }}"
              ...
              <div class="mt-4 p-4 bg-gray-800/50 rounded-lg border border-gray-700">
                ...
                <div class="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-3">
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.simpleicons.org/laravel/FF2D20" title="Laravel">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" title="React">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vuejs/vuejs-original.svg" title="Vue.js">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/angularjs/angularjs-original.svg" title="Angular">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg" title="Node.js">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" title="Python">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/php/php-original.svg" title="PHP">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" title="JavaScript">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg" title="TypeScript">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.simpleicons.org/tailwindcss/06B6D4" title="Tailwind CSS">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg" title="Bootstrap">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" title="MySQL">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg" title="PostgreSQL">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg" title="MongoDB">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg" title="Docker">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" title="Git">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg" title="GitHub">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg" title="Figma">
                  ...
                  <button type="button" class="icon-option p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 hover:border-cyan-500 transition-all" data-icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg" title="Next.js">
                ...
                <p class="mt-3 text-xs text-gray-500">Click an icon to update. Or find more at <a href="https://devicon.dev/" target="_blank" class="text-cyan-400 hover:text-cyan-300">devicon.dev</a></p>
              </div>
            ...
            <script>
              ...
              document.querySelectorAll('.icon-option').forEach(button => {
                button.addEventListener('click', function(e) {
                  ...
                  // Update preview
                  document.getElementById('preview-image').src = iconUrl;
            ...
            <div class="mb-6">
              ...
              <input
                ...
                id="order"
                name="order"
                value="{{ old('order', $techStack->order) }}"
                min="0"
